...
```{r fig.7, fig.width=9, fig.height=9, fig.cap="**oben:** Anzahl der kontrollierten Kästen in Summe und nach Kastenzustand **unten:** Summe der kontrollierten Kästen korrigiert durch die Anzahl der kontrollierten Schläge", warning=F}
par(mfrow=c(2,1))
